...
* **Color and Drawing Mode:** Right-click (or long press with touch controls) to open a menu. Adjust the color or drawing mode during the annotation process ![Annot Menu](imgs/Annot-Menu.png)
